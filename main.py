...
def dataset_setup(args):
    ...
    # KITTI:
        ...
        args.nonmaximum_supression_radius = 3
        args.max_num_new_keypoints = 4000
        
        args.RANSAC_iterationsCount = 20000
        args.RANSAC_reprojectionError= 1
        args.RANSAC_confidence = 0.999
        args.KLT_window_size = 15
        args.KLT_max_level = 3
        args.KLT_criteria = (cv2.TERM_CRITERIA_EPS | cv2.TERM_CRITERIA_COUNT, 350, 0.001)


        args.bootstrap_frames = 15
    ...
    if ds == 0:
        start = 0
        bootstrap_frames = [start, start + args.bootstrap_frames] # having more than 2 frames in between brakes ground thruth calculation
